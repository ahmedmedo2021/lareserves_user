...
class DatePickerController {
  ...
  void jumpToSelection() {
    ...
    _datePickerState._controller
        .jumpTo(_calcuDateOffset(_datePickerState._currentDate));
  }
  ...
  void animateToSelection(
    ...
    _datePickerState._controller.animateTo(
        _calcuDateOffset(_datePickerState._currentDate),
        duration: duration,
        curve: curve);
  }
  ...
  void animateToDate(DateTime date,
    ...
    _datePickerState._controller.animateTo(_calcuDateOffset(date),
        duration: duration, curve: curve);
  }

  /// Calcu the number of pixels that needs to be scrolled to go to the
  /// date provided in the argument
  double _calcuDateOffset(DateTime date) {
