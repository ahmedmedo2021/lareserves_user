...
import 'package:travel_app_temp/models/car_dealer.dart';
import 'package:travel_app_temp/models/car_model.dart';
import 'package:travel_app_temp/screens/car_rental/car_details.dart';
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Text(
          filter.name,
          style: TextStyle(
            color: selectedFilter == filter ? ColorsConstants.appColor : Colors.grey[300],
            fontSize: 16,
