...
import 'package:travel_app_temp/screens/search/ui_helper.dart';
import 'package:travel_app_temp/utils/blurry_container.dart';
...
class _SearchScreenState extends State<SearchScreen>
  ...
  Future<bool> _calcuDistance() async {
    try {
                          ...
                          ElevatedButton(
                            onPressed: (_startAddress != '' &&
                                ...
                                ? () async {
                                    ...
                                    _calcuDistance().then((isCalcud) {
                                      if (isCalcud) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          const SnackBar(
                                            content: Text(
                                                'Distance Calcud Successfully'),
                                          ),
                                        );
                                      } else {
                                        ScaffoldMessenger.of(context)
