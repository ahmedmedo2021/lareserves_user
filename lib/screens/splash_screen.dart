...
import 'package:travel_app_temp/walkthrough/travel_walkthrough.dart';
  ...
  void initState() {
    ...
    Timer(
        ...
        () => Navigator.of(context).pushReplacement(
            CommonFunctions.pushWithRightAnimation(child: const TravelWalkThrough(),
            ...
            Column(
              children: [
                ...
                Lottie.asset('assets/images/splash_loading.json',
                    height: MediaQuery.of(context).size.height*0.3+50,width: MediaQuery.of(context).size.height*0.3+50,repeat: true),
