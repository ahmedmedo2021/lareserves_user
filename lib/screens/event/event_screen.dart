...
import 'package:travel_app_temp/models/event_type_model.dart';
import 'package:travel_app_temp/models/near_by_model.dart';
import 'package:travel_app_temp/utils/colors_const.dart';
import 'package:travel_app_temp/utils/common_functions.dart';
import 'package:travel_app_temp/utils/date_time_picker/date_picker_widget.dart';
import 'package:travel_app_temp/utils/datetime_utils.dart';
      ...
      children: <Widget>[
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: <Widget>[
              Text(DateTimeUtils.getMonth(event.eventDate), style: TextStyle(color: ColorsConstants.appColor, fontSize: 16, fontWeight: FontWeight.w500)),
