...
import 'package:travel_app_temp/screens/signup.dart';
      ...
      bottomSheet: _currentPage == _numPages - 1
          ? GestureDetector(
            ...
            //   Navigator.of(context).push(MaterialPageRoute(builder: (context)=>));
               Navigator.of(context).push(CommonFunctions.pushWithTopAnimation(child:  const SignInScreen(), duration: const Duration(milliseconds: 620)));
              },
              child: Container(
